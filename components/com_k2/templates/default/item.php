...
<?php if (Factory::getApplication()->input->getInt('print') == 1): ?>
    <!-- Print button at the top of the print page only -->
    <a class="itemPrintThisPage" rel="nofollow" href="#" onclick="window.print();return false;">
        <span><?php echo Text::_('K2_PRINT_THIS_PAGE'); ?></span>
    </a>
<?php endif; ?>

<!-- Start K2 Item Layout -->
<span id="startOfPageId<?php echo Factory::getApplication()->input->getInt('id'); ?>"></span>

<div id="k2Container"
     class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if ($this->item->params->get('pageclass_sfx')) echo ' ' . $this->item->params->get('pageclass_sfx'); ?>">
    ...
    <div class="itemHeader">
        ...
        <?php if ($this->item->params->get('itemTitle')): ?>
            ...
            <h2 class="itemTitle">
                ...
                <a data-k2-modal="edit"
                   href="<?php echo $this->item->editLink; ?>"><?php echo Text::_('K2_EDIT_ITEM'); ?></a>
            </span>
                <?php endif; ?>
        ...
        <div class="itemToolbar">
            <ul>
                <?php if ($this->item->params->get('itemFontResizer')): ?>
                    <!-- Font Resizer -->
                    <li>
                        <span class="itemTextResizerTitle"><?php echo Text::_('K2_FONT_SIZE'); ?></span>
                        <a href="#" id="fontDecrease">
                            <span><?php echo Text::_('K2_DECREASE_FONT_SIZE'); ?></span>
                        </a>
                        <a href="#" id="fontIncrease">
                            <span><?php echo Text::_('K2_INCREASE_FONT_SIZE'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>

                <?php if ($this->item->params->get('itemPrintButton') && !Factory::getApplication()->input->getInt('print')): ?>
                    <!-- Print Button -->
                    <li>
                        <a class="itemPrintLink" rel="nofollow" href="<?php echo $this->item->printLink; ?>"
                           onclick="window.open(this.href,'printWindow','width=900,height=600,location=no,menubar=no,resizable=yes,scrollbars=yes'); return false;">
                            <span><?php echo Text::_('K2_PRINT'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                    ...
                    <li>
                        <a class="itemEmailLink" rel="nofollow" href="<?php echo $this->item->emailLink; ?>"
                           onclick="window.open(this.href,'emailWindow','width=400,height=350,location=no,menubar=no,resizable=no,scrollbars=no'); return false;">
                            <span><?php echo Text::_('K2_EMAIL'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if ($this->item->params->get('itemVideoAnchor') && !empty($this->item->video)): ?>
                    ...
                    <li>
                        <a class="itemVideoLink k2Anchor"
                           href="<?php echo $this->item->link; ?>#itemVideoAnchor"><?php echo Text::_('K2_MEDIA'); ?></a>
                    </li>
                <?php endif; ?>
                ...
                <?php if ($this->item->params->get('itemImageGalleryAnchor') && !empty($this->item->gallery)): ?>
                    ...
                    <li>
                        <a class="itemImageGalleryLink k2Anchor"
                           href="<?php echo $this->item->link; ?>#itemImageGalleryAnchor"><?php echo Text::_('K2_IMAGE_GALLERY'); ?></a>
                    </li>
                <?php endif; ?>
                            ...
                            <?php if ($this->item->numOfComments > 0): ?>
                                <a class="itemCommentsLink k2Anchor"
                                   href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
                                    <span><?php echo $this->item->numOfComments; ?></span> <?php echo ($this->item->numOfComments > 1) ? Text::_('K2_COMMENTS') : Text::_('K2_COMMENT'); ?>
                                </a>
                            <?php else: ?>
                                <a class="itemCommentsLink k2Anchor"
                                   href="<?php echo $this->item->link; ?>#itemCommentsAnchor"><?php echo Text::_('K2_BE_THE_FIRST_TO_COMMENT'); ?></a>
                            <?php endif; ?>
                        <?php endif; ?>
                    </li>
                <?php endif; ?>
    ...
    <?php if ($this->item->params->get('itemRating')): ?>
        ...
        <div class="itemRatingBlock">
            <span><?php echo Text::_('K2_RATE_THIS_ITEM'); ?></span>
            <div class="itemRatingForm">
                <ul class="itemRatingList">
                    ...
                    <li><a href="#" data-id="<?php echo $this->item->id; ?>"
                           title="<?php echo Text::_('K2_1_STAR_OUT_OF_5'); ?>" class="one-star">1</a></li>
                    <li><a href="#" data-id="<?php echo $this->item->id; ?>"
                           title="<?php echo Text::_('K2_2_STARS_OUT_OF_5'); ?>" class="two-stars">2</a></li>
                    <li><a href="#" data-id="<?php echo $this->item->id; ?>"
                           title="<?php echo Text::_('K2_3_STARS_OUT_OF_5'); ?>" class="three-stars">3</a></li>
                    <li><a href="#" data-id="<?php echo $this->item->id; ?>"
                           title="<?php echo Text::_('K2_4_STARS_OUT_OF_5'); ?>" class="four-stars">4</a></li>
                    <li><a href="#" data-id="<?php echo $this->item->id; ?>"
                           title="<?php echo Text::_('K2_5_STARS_OUT_OF_5'); ?>" class="five-stars">5</a></li>
                </ul>
    ...
    <div class="itemBody">
        ...
        <?php if ($this->item->params->get('itemImage') && !empty($this->item->image)): ?>
            ...
            <span class="itemImage">
                <a data-k2-modal="image" href="<?php echo $this->item->imageXLarge; ?>"
                   title="<?php echo Text::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
        ...
        <?php if ($this->item->params->get('itemExtraFields') && isset($this->item->extra_fields) && count($this->item->extra_fields)): ?>
            ...
            <div class="itemExtraFields">
                <h3><?php echo Text::_('K2_ADDITIONAL_INFO'); ?></h3>
                <ul>
        ...
        <?php if ($this->item->params->get('itemHits') || ($this->item->params->get('itemDateModified') && intval($this->item->modified) != 0)): ?>
            <div class="itemContentFooter">
                <?php if ($this->item->params->get('itemHits')): ?>
                    <!-- Item Hits -->
                    <span class="itemHits">
                <?php echo Text::_('K2_READ'); ?> <b><?php echo $this->item->hits; ?></b> <?php echo Text::_('K2_TIMES'); ?>
            </span>
                <?php endif; ?>
            ...
            <?php if ($this->item->params->get('itemTwitterButton')): ?>
                ...
                <div class="itemTwitterButton">
                    <a href="https://twitter.com/share" class="twitter-share-button"
                       data-url="<?php echo $this->item->sharinglink; ?>"
                       data-via="<?php if ($this->item->params->get('twitterUsername')) echo $this->item->params->get('twitterUsername'); ?>"
                       data-related="<?php if ($this->item->params->get('twitterUsername')) echo $this->item->params->get('twitterUsername'); ?>"
                       data-lang="<?php echo $this->item->langTagForTW; ?>" data-dnt="true"
            ...
            <?php if ($this->item->params->get('itemFacebookButton')): ?>
                ...
                <div class="itemFacebookButton">
                    ...
                    <script async defer crossorigin="anonymous"
                            src="https://connect.facebook.net/<?php echo $this->item->langTagForFB; ?>/sdk.js#xfbml=1&version=v3.3"></script>
                    <div class="fb-like" data-href="<?php echo $this->item->sharinglink; ?>" data-width="160"
        ...
        <div class="itemLinks">
            <?php if ($this->item->params->get('itemCategory')): ?>
                ...
                <div class="itemCategory">
                    <span><?php echo Text::_('K2_PUBLISHED_IN'); ?></span>
            ...
            <?php if ($this->item->params->get('itemTags') && isset($this->item->tags) && count($this->item->tags)): ?>
                ...
                <div class="itemTagsBlock">
                    <span><?php echo Text::_('K2_TAGGED_UNDER'); ?></span>
                    <ul class="itemTags">
            ...
            <?php if ($this->item->params->get('itemAttachments') && isset($this->item->attachments) && count($this->item->attachments)): ?>
                ...
                <div class="itemAttachmentsBlock">
                    <span><?php echo Text::_('K2_DOWNLOAD_ATTACHMENTS'); ?></span>
                    <ul class="itemAttachments">
                        <?php foreach ($this->item->attachments as $attachment): ?>
                            <li>
                                <a title="<?php echo ($attachment->titleAttribute) ? K2HelperUtilities::cleanHtml($attachment->titleAttribute) : K2HelperUtilities::cleanHtml($attachment->filename); ?>"
                                   href="<?php echo $attachment->link; ?>">
                                    <?php echo ($attachment->title) ? $attachment->title : $attachment->filename; ?>
                                </a>
                                <?php if ($this->item->params->get('itemAttachmentsCounter')): ?>
                                    <span>(<?php echo $attachment->hits; ?> <?php echo ($attachment->hits == 1) ? Text::_('K2_DOWNLOAD') : Text::_('K2_DOWNLOADS'); ?>)</span>
                                <?php endif; ?>
                            </li>
                        <?php endforeach; ?>
                    </ul>
        ...
        <div class="itemAuthorBlock">
            ...
            <div class="itemAuthorDetails">
                ...
                <?php if ($this->item->params->get('itemAuthorURL') && !empty($this->item->author->profile->url)): ?>
                    <span class="itemAuthorUrl"><i class="icon-globe"></i> <a rel="me"
    ...
    */
    ...
    <?php if ($this->item->params->get('itemAuthorLatest') && empty($this->item->created_by_alias) && isset($this->authorLatestItems)): ?>
        ...
        <div class="itemAuthorLatest">
            <h3><?php echo Text::_('K2_LATEST_FROM'); ?><?php echo $this->item->author->name; ?></h3>
            <ul>
    ...
    */
    ...
    <?php if ($this->item->params->get('itemRelated') && isset($this->relatedItems)): ?>
        ...
        <div class="itemRelated">
            <h3><?php echo Text::_("K2_RELATED_ITEMS_BY_TAG"); ?></h3>
            <ul>
                <?php foreach ($this->relatedItems as $key => $item): ?>
                    <li class="<?php echo ($key % 2) ? "odd" : "even"; ?>">
                        ...
                        <?php if ($this->item->params->get('itemRelatedImageSize') && !empty($item->image)): ?>
                            <img style="width:<?php echo $item->imageWidth; ?>px;height:auto;" class="itemRelImg"
    ...
    <?php if ($this->item->params->get('itemVideo') && !empty($this->item->video)): ?>
        ...
        <div class="itemVideoBlock">
            <h3><?php echo Text::_('K2_MEDIA'); ?></h3>
    ...
    <?php if ($this->item->params->get('itemImageGallery') && !empty($this->item->gallery)): ?>
        ...
        <div class="itemImageGallery">
            <h3><?php echo Text::_('K2_IMAGE_GALLERY'); ?></h3>
    ...
    <?php if ($this->item->params->get('itemNavigation') && !Factory::getApplication()->input->getCmd('print') && (isset($this->item->nextLink) || isset($this->item->previousLink))): ?>
        <!-- Item navigation -->
        <div class="itemNavigation">
            <span class="itemNavigationTitle"><?php echo Text::_('K2_MORE_IN_THIS_CATEGORY'); ?></span>

            <?php if (isset($this->item->previous->link)): ?>
                <a class="itemPrevious"
                   href="<?php echo $this->item->previous->link; ?>">&laquo; <?php echo $this->item->previous->title; ?></a>
            <?php endif; ?>

            <?php if (isset($this->item->next->link)): ?>
                <a class="itemNext"
                   href="<?php echo $this->item->next->link; ?>"><?php echo $this->item->next->title; ?> &raquo;</a>
            <?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <?php if (
        ...
        <div class="itemComments">
            <?php if ($this->item->params->get('commentsFormPosition') == 'above' && $this->item->params->get('itemComments') && !Factory::getApplication()->input->getInt('print') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2' && K2HelperPermissions::canAddComment($this->item->catid)))): ?>
                <!-- Item comments form -->
                ...
                <span class="commentLink">
                    <a href="<?php echo $this->item->link; ?>#comment<?php echo $comment->id; ?>"
                       name="comment<?php echo $comment->id; ?>" id="comment<?php echo $comment->id; ?>">
                        <?php echo Text::_('K2_COMMENT_LINK'); ?>
                    </a>
                </span>
                    ...
                    <?php echo Text::_('K2_POSTED_BY'); ?>
                                <?php if (!empty($comment->userLink)): ?>
                                    <a href="<?php echo OutputFilter::cleanText($comment->userLink); ?>"
                                       title="<?php echo OutputFilter::cleanText($comment->userName); ?>"
                                       target="_blank" rel="nofollow"><?php echo $comment->userName; ?></a>
                                <?php else: ?>
                    ...
                    <?php if ($this->inlineCommentsModeration): ?>
                        <?php if (!$comment->published): ?>
                            <a class="commentApproveLink"
                               href="<?php echo Route::_('index.php?option=com_k2&view=comments&task=publish&commentID=' . $comment->id . '&format=raw') ?>"><?php echo Text::_('K2_APPROVE') ?></a>
                        <?php endif; ?>

                    <a class="commentRemoveLink"
                       href="<?php echo Route::_('index.php?option=com_k2&view=comments&task=remove&commentID=' . $comment->id . '&format=raw') ?>"><?php echo Text::_('K2_REMOVE') ?></a>
                    <?php endif; ?>

                                    <?php if ($comment->published && ($this->params->get('commentsReporting') == '1' || ($this->params->get('commentsReporting') == '2' && !$this->user->guest))): ?>
                                        <a data-k2-modal="iframe"
                                           href="<?php echo Route::_('index.php?option=com_k2&view=comments&task=report&commentID=' . $comment->id) ?>"><?php echo Text::_('K2_REPORT') ?></a>
                                    <?php endif; ?>
            ...
            <?php if (
                ...
                $this->item->params->get('itemComments') &&
                !Factory::getApplication()->input->getInt('print') &&
            ...
            if ($this->item->params->get('comments') == '2' && $user->guest): ?>
                <div class="itemCommentsLoginFirst"><?php echo Text::_('K2_LOGIN_TO_POST_COMMENTS'); ?></div>
            <?php endif; ?>
        </div>
    <?php endif; ?>

    <?php if (!Factory::getApplication()->input->getCmd('print')): ?>
        <div class="itemBackToTop">
            <a class="k2Anchor"
               href="<?php echo $this->item->link; ?>#startOfPageId<?php echo Factory::getApplication()->input->getInt('id'); ?>">
                <?php echo Text::_('K2_BACK_TO_TOP'); ?>
            </a>
        </div>
    <?php endif; ?>
