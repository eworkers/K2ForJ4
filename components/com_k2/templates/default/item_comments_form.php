...
<!-- Comments Form -->
<h3><?php echo Text::_('K2_LEAVE_A_COMMENT') ?></h3>
...
<?php if ($this->params->get('commentsFormNotes')): ?>
    <p class="itemCommentsFormNotes">
        ...
        <?php else: ?>
            <?php echo Text::_('K2_COMMENT_FORM_NOTES') ?>
        <?php endif; ?>
    </p>
<?php endif; ?>
...
<form action="<?php echo JURI::root(true); ?>/index.php" method="post" id="comment-form" class="form-validate">
    ...
    <input class="inputbox" type="text" name="commentEmail" id="commentEmail"
           ...
           onfocus="if(this.value=='<?php echo Text::_('K2_ENTER_YOUR_EMAIL_ADDRESS'); ?>') this.value='';"/>

    <label class="formUrl" for="commentURL"><?php echo Text::_('K2_WEBSITE_URL'); ?></label>
    <input class="inputbox" type="text" name="commentURL" id="commentURL"
           value="<?php echo Text::_('K2_ENTER_YOUR_SITE_URL'); ?>"
           onblur="if(this.value=='') this.value='<?php echo Text::_('K2_ENTER_YOUR_SITE_URL'); ?>';"
           onfocus="if(this.value=='<?php echo Text::_('K2_ENTER_YOUR_SITE_URL'); ?>') this.value='';"/>
    ...
    <input type="submit" class="button" id="submitCommentButton" value="<?php echo Text::_('K2_SUBMIT_COMMENT'); ?>"/>
    ...
    <input type="hidden" name="itemID" value="<?php echo Factory::getApplication()->input->getInt('id'); ?>"/>
