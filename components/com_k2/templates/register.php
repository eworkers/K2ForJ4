    ...
    <div id="k2Container" class="k2AccountPage">
        <table class="admintable" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="<?php echo $this->nameFieldName; ?>" id="name" size="40"
                           value="<?php echo $this->escape($this->user->get('name')); ?>" class="inputbox required"
                           maxlength="50"/>
                    *
                </td>
            </tr>
            <tr>
                <td class="key">
                    <label id="usernamemsg" for="username"><?php echo Text::_('K2_USER_NAME'); ?></label>
                </td>
                <td>
                    <input type="text" id="username" name="<?php echo $this->usernameFieldName; ?>" size="40"
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="email" name="<?php echo $this->emailFieldName; ?>" size="40"
            ...
            <tr>
                ...
                <td>
                    <input class="inputbox required validate-password" type="password" id="password"
            ...
            <tr>
                ...
                <td>
                    <input class="inputbox required validate-passverify" type="password" id="password2"
        ...
        <div class="k2AccountPageNotice"><?php echo Text::_('K2_REGISTER_REQUIRED'); ?></div>
        <div class="k2AccountPageUpdate">
            <button class="button validate" type="submit">
                <?php echo Text::_('K2_REGISTER'); ?>
            </button>
        </div>
    </div>
