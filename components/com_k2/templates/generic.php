...
<div id="k2Container" class="genericView">
    <?php if (Factory::getApplication()->input->getCmd('task') == 'search'): ?>
        <form action="<?php echo $this->form->action; ?>" method="get" autocomplete="off" class="genericSearchForm">
            <input type="text" value="<?php echo $this->form->input; ?>" name="searchword" class="k2-input"
                   placeholder="<?php echo Text::_('K2_SEARCH'); ?>"/>
            <input type="submit" value="<?php echo Text::_('K2_SEARCH'); ?>" class="k2-submit"/>
    ...
    <?php if ($this->params->get('genericTitle', 1)): ?>
        ...
        <h1><?php echo (Factory::getApplication()->input->getCmd('task') == 'date') ? Text::_('K2_ITEMS_FILTERED_BY_DATE') : Text::_('K2_SEARCH_RESULTS_FOR'); ?><?php echo $this->title; ?></h1>
    <?php endif; ?>
    ...
    <?php else: ?>
        ...
        <div id="genericItemListNothingFound">
            <p><?php echo Text::_('K2_NO_RESULTS_FOUND'); ?></p>
        </div>
