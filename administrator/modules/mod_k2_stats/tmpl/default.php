...
<?php echo JHtmlBootstrap::startTabSet('k2StatsTabs', ['active' => 'latestItemsTab']);?>

<?php if($params->get('latestItems', 1)): ?>
    <?php echo JHtmlBootstrap::addTab('k2StatsTabs', 'latestItemsTab', Text::_('K2_LATEST_ITEMS')); ?>
...
<?php if($params->get('popularItems', 1)): ?>
    <?php echo JHtmlBootstrap::addTab('k2StatsTabs', 'popularItemsTab' , Text::_('K2_POPULAR_ITEMS')); ?>
    <table class="adminlist table table-striped">
        <thead>
        <tr>
            <td class="title"><?php echo Text::_('K2_TITLE'); ?></td>
...
<?php if($params->get('mostCommentedItems', 1)): ?>
    <?php echo JHtmlBootstrap::addTab('k2StatsTabs', 'mostCommentedItemsTab', Text::_('K2_MOST_COMMENTED_ITEMS')); ?>
    <table class="adminlist table table-striped">
        <thead>
        <tr>
            <td class="title"><?php echo Text::_('K2_TITLE'); ?></td>
...
<?php if($params->get('latestComments', 1)): ?>
    <?php echo JHtmlBootstrap::addTab('k2StatsTabs', 'latestCommentsTab', Text::_('K2_LATEST_COMMENTS')); ?>
    <table class="adminlist table table-striped">
        <thead>
        <tr>
...
<?php if($params->get('statistics', 1)): ?>
    <?php echo JHtmlBootstrap::addTab('k2StatsTabs', 'statsTab', Text::_('K2_STATISTICS')); ?>
    <table class="adminlist table table-striped">
        <thead>
        <tr>
