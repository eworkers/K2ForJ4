    ...
    <div class="k2AdminTableData">
        <table class="adminlist table table-striped<?php if (isset($this->rows) && count($this->rows) == 0): ?> nocontent<?php endif; ?>"
            ...
            <tr>
                ...
                <th><?php echo Text::_('K2_GROUP_NAME'); ?></th>
                <th class="k2ui-hide-on-mobile"><?php echo Text::_('K2_ASSIGNED_CATEGORIES'); ?></th>
            </tr>
            </thead>
            <tfoot>
            <tr>
                ...
                <tr>
                    <td colspan="4" class="k2ui-nocontent">
                        <div class="k2ui-nocontent-message">
                            <i class="fa fa-list"
                               aria-hidden="true"></i><?php echo Text::_('K2_BE_NO_EXTRA_FIELD_GROUPS_FOUND'); ?>
                        </div>
                    </td>
                </tr>
            <?php endif; ?>
