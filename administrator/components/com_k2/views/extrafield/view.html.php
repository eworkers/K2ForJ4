    ...
    public function display($tpl = null)
    {
        ...
        $document->addScriptDeclaration('
            ...
            var K2Language = [
                ...
                "' . Text::_('K2_COMMA_SEPARATED_VALUES', true) . '",
                "' . Text::_('K2_USE_EDITOR', true) . '",
                "' . Text::_('K2_ALL_SETTINGS_ABOVE_ARE_OPTIONAL', true) . '",
                "' . Text::_('K2_ADD_AN_OPTION', true) . '",
                "' . Text::_('K2_LINK_TEXT', true) . '",
                "' . Text::_('K2_URL', true) . '",
                "' . Text::_('K2_OPEN_IN', true) . '",
                "' . Text::_('K2_SAME_WINDOW', true) . '",
                "' . Text::_('K2_NEW_WINDOW', true) . '",
                "' . Text::_('K2_CLASSIC_JAVASCRIPT_POPUP', true) . '",
                "' . Text::_('K2_LIGHTBOX_POPUP', true) . '",
                "' . Text::_('K2_RESET_VALUE', true) . '",
                "' . Text::_('K2_CALENDAR', true) . '",
                "' . Text::_('K2_PLEASE_SELECT_A_FIELD_TYPE_FROM_THE_LIST_ABOVE', true) . '",
                "' . Text::_('K2_COLUMNS', true) . '",
                "' . Text::_('K2_ROWS', true) . '",
                "' . Text::_('K2_SELECT', true) . '"
            ];
            Joomla.submitbutton = function(pressbutton) {
                ...
                if ($K2.trim($K2("#group").val()) == "") {
                    alert("' . Text::_('K2_PLEASE_SELECT_A_GROUP_OR_CREATE_A_NEW_ONE', true) . '");
                } else if ($K2.trim($K2("#name").val()) == "") {
                    alert("' . Text::_('K2_NAME_CANNOT_BE_EMPTY', true) . '");
                } else if ($K2("#type").val() == "0") {
                    alert("' . Text::_('K2_PLEASE_SELECT_THE_TYPE_OF_THE_EXTRA_FIELD', true) . '");
                } else {
                    Joomla.submitform(pressbutton);
                }
            };
