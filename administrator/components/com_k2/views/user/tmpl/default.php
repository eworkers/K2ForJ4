...
<form action="index.php" enctype="multipart/form-data" method="post" name="adminForm" id="adminForm">
    <div class="xmlParamsFields k2GenericForm">
        <h3><?php echo Text::_('K2_EDIT_USER'); ?></h3>
        <ul class="adminformlist">
            <li>
                <div class="paramLabel">
                    <label><?php echo Text::_('K2_NAME'); ?></label>
                </div>
            ...
            <li>
                <div class="paramLabel">
                    <label><?php echo Text::_('K2_GENDER'); ?></label>
                </div>
                <div class="paramValue">
            ...
            <li>
                <div class="paramLabel">
                    <label><?php echo Text::_('K2_USER_GROUP'); ?></label>
                </div>
                <div class="paramValue">
            ...
            <li>
                <div class="paramLabel">
                    <label><?php echo Text::_('K2_USER_IMAGE_AVATAR'); ?></label>
                </div>
                <div class="paramValue">
                    ...
                    <?php if ($this->row->image):
                        ...
                        <div class="k2ImagePreview">
                            <a href="<?php echo $avatar; ?>" title="<?php echo Text::_('K2_PREVIEW_IMAGE'); ?>"
                               data-fancybox="gallery" data-caption="<?php echo $this->row->name; ?>">
                                <img class="k2AdminImage" src="<?php echo $avatar; ?>"
                                     alt="<?php echo $this->row->name; ?>"/>
                            </a>
                            <br/>
            ...
            <li>
                <div class="paramLabel">
                    <label><?php echo Text::_('K2_URL'); ?></label>
                </div>
                <div class="paramValue">
            ...
            <li>
                <div class="paramLabel">
                    <label><?php echo Text::_('K2_NOTES'); ?></label>
                </div>
                <div class="paramValue">
