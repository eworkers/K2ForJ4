    ...
    public function fetchElement($name, $value, &$node, $control_name)
    {
        ...
        if ($scope == 'items' || $scope == 'categories' || $scope == 'users' || $scope == 'tags') {
            ...
            <div class="k2SelectorButton">
                <a data-k2-modal="iframe" class="btn" title="' . Text::_('K2_SELECT') . '" href="index.php?option=com_k2&view=' . $scope . '&tmpl=component&context=modalselector&output=list&fid=' . $fieldID . '&fname=' . $fieldName . '">
                    <i class="fa fa-file-text-o"></i> ' . Text::_('K2_SELECT') . '
                </a>
            </div>
            ...
            foreach ($saved as $value) {
                ...
                $output .= '<li class="handle"><a class="k2EntryRemove" href="#" title="' . Text::_('K2_REMOVE_THIS_ENTRY') . '"><i class="fa fa-trash-o"></i></a><span class="k2EntryText">' . $entryName . '</span><input type="hidden" name="' . $fieldName . '" value="' . $entryValue . '" /></li>';
            }
            $output .= '
            </ul>
            ';
        ...
        if ($scope == 'item' || $scope == 'category' || $scope == 'user' || $scope == 'tag') {
            ...
            <div class="k2SelectorButton k2SingleSelect">
                <a data-k2-modal="iframe" class="btn" title="' . Text::_('K2_SELECT') . '" href="index.php?option=com_k2&view=' . $view . '&tmpl=component&context=modalselector&fid=' . $fieldID . '&fname=' . $fieldName . '">
                    <i class="fa fa-file-text-o"></i> ' . Text::_('K2_SELECT') . '
                </a>
            </div>
            ...
            if ($value) {
                $output .= '<div class="handle"><a class="k2EntryRemove" href="#" title="' . Text::_('K2_REMOVE_THIS_ENTRY') . '"><i class="fa fa-trash-o"></i></a><span class="k2EntryText">' . $entryName . '</span><input type="hidden" name="' . $fieldName . '" value="' . $entryValue . '" /></div>';
            }
            $output .= '
            </div>
            ';
