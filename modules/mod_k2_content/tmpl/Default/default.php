    ...
    <?php if (isset($items) && count($items)): ?>
        <ul>
            <?php foreach ($items as $key => $item): ?>
                ...
                if (count($items) == $key + 1) echo ' lastItem'; ?>">
                        ...
                        <div class="moduleItemIntrotext">
                            <?php if ($params->get('itemImage') && !empty($item->image)): ?>
                                <a class="moduleItemImage" href="<?php echo $item->link; ?>"
                                   title="<?php echo Text::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
                    ...
                    <?php if ($params->get('itemExtraFields') && isset($item->extra_fields) && count($item->extra_fields)): ?>
                        <div class="moduleItemExtraFields">
                            <b><?php echo Text::_('K2_ADDITIONAL_INFO'); ?></b>
                            <ul>
                ...
                <?php echo Text::_('K2_WRITTEN_ON') .' '. HTMLHelper::_('date', $item->created, Text::_('K2_DATE_FORMAT_LC2')); ?>
            </span>
                    <?php endif; ?>

                    <?php if ($params->get('itemCategory')): ?>
                        <?php echo Text::_('K2_IN'); ?> <a class="moduleItemCategory"
                        ...
                        <?php else: ?>
                            <?php if ($item->numOfComments > 0): ?>
                                <a class="moduleItemComments" href="<?php echo $item->link . '#itemCommentsAnchor'; ?>">
                                    <?php echo $item->numOfComments; ?><?php if ($item->numOfComments > 1) echo Text::_('K2_COMMENTS'); else echo Text::_('K2_COMMENT'); ?>
                                </a>
                            <?php else: ?>
                                <a class="moduleItemComments" href="<?php echo $item->link . '#itemCommentsAnchor'; ?>">
                ...
                <?php echo Text::_('K2_READ'); ?><?php echo $item->hits; ?><?php echo Text::_('K2_TIMES'); ?>
            </span>
                    <?php endif; ?>
