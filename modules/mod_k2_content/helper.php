                ...
                case 'hits':
                    if ($params->get('popularityRange')) {
                        if ($params->get('popularityRange') == 'today') {
                            $date = $jnow->format('%Y-%m-%d') . ' 00:00:00';
        ...
        */
        ...
        if (count($items)) {
            foreach ($items as $item) {
                ...
                if (Factory::getApplication()->input->getCmd('format') == 'feed') {
                    $tagsForFeed = array();
                    ...
                    if (Factory::getApplication()->input->getBool('tagsontitle', false) && is_array($tagsForFeed) && count($tagsForFeed)) {
