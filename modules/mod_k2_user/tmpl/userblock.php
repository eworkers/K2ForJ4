...
<div id="k2ModuleBox<?php echo $module->id; ?>"
     class="k2UserBlock<?php if ($params->get('moduleclass_sfx')) echo ' ' . $params->get('moduleclass_sfx'); ?>">
    ...
    <div class="k2UserBlockDetails">
        <?php if ($params->get('userAvatar')): ?>
            <a class="k2Avatar ubAvatar" href="<?php echo Route::_(K2HelperRoute::getUserRoute($user->id)); ?>"
               title="<?php echo Text::_('K2_MY_PAGE'); ?>">
                <img src="<?php echo K2HelperUtilities::getAvatar($user->id, $user->email); ?>"
                     alt="<?php echo K2HelperUtilities::cleanHtml($user->name); ?>"
                     style="width:<?php echo $avatarWidth; ?>px;height:auto;"/>
            </a>
        <?php endif; ?>
        <span class="ubName"><?php echo $user->name; ?></span>
        <span class="ubCommentsCount"><?php echo Text::_('K2_YOU_HAVE'); ?> <b><?php echo $user->numOfComments; ?></b> <?php if ($user->numOfComments == 1) echo Text::_('K2_PUBLISHED_COMMENT'); else echo Text::_('K2_PUBLISHED_COMMENTS'); ?></span>
        <div class="clr"></div>
    </div>
    ...
    <ul class="k2UserBlockActions">
        <?php if (isset($addItemLink)): ?>
            <li>
                <a data-k2-modal="edit" href="<?php echo $addItemLink; ?>"><?php echo Text::_('K2_ADD_NEW_ITEM'); ?></a>
            </li>
        <?php endif; ?>
        <li>
            <a href="<?php echo $viewProfileLink; ?>"><?php echo Text::_('K2_MY_PAGE'); ?></a>
        </li>
        <li>
            <a href="<?php echo $editProfileLink; ?>"><?php echo Text::_('K2_MY_ACCOUNT'); ?></a>
        </li>
        <?php if ($K2CommentsEnabled): ?>
            <li>
                <a data-k2-modal="iframe"
                   href="<?php echo $editCommentsLink; ?>"><?php echo Text::_('K2_MODERATE_COMMENTS_TO_MY_PUBLISHED_ITEMS'); ?></a>
            </li>
        <?php endif; ?>
    </ul>
